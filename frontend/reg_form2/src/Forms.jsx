...
setviewfile(data);
  ...
  const handleReferenceIdChange = (field, value) => {
    setFormData({
      ...formData,
  ...
  const DocumentUploadSection = ({ title, field, required = false, documentType }) => {
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="flex items-center space-x-2">
                { (
                  ...
                  >
                    <Eye className="w-5 h-5"   onClick={(e) => handle_open_file(data)}
  />
                  </button>
                )}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4 reg">
      <div className=''>
      
      <div className="max-w-6xl mx-auto  reg1">
